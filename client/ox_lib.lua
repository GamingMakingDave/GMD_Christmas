        ...
        options = {
            {
                ...
                onSelect = function()
                    Wait(500)
                    showsubtitle("Danke dir nochmals für deine Hilfe!!", 2000)
                    Wait(2500)
                    showsubtitle("Wenn du magst könntest du mir helfen Geschenke auszuliefern?", 3000)
                    Wait(3500)
                    showsubtitle("Ich Belohne dich mit Goldene Tickets", 2000)
                    Wait(2500)
                    GiftJob()
                end,
            }
